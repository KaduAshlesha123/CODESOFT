...
class Quiz implements ActionListener{
	...
	String[][] options = 	{	{"Steve Jobs","Bill Gates","James Gosling","Mark Zuckerburg"},
								{"Bill Gates","Sunder Pichai","Staya Nadella","Mark Zukerburg"},
								{"Max Versatppen","Jeff Bezos","Elon Musk","None of the above"},
	...
	public Quiz() {
		...
		textfield.setBackground(new Color(173,216,230/*25,25,25*/));
